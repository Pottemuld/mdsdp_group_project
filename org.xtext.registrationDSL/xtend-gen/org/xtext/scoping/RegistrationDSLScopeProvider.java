...
public class RegistrationDSLScopeProvider extends AbstractRegistrationDSLScopeProvider {
  ...
  public IScope getScope(final EObject context, final EReference reference) {
    IScope _xblockexpression = null;
    {
      ...
      if (context instanceof Variable) {
        boolean _equals = Objects.equal(reference, RegistrationDSLPackage.Literals.VARIABLE__NAME);
        if (_equals) {
          _matched=true;
          final Entity entity = EcoreUtil2.<Entity>getContainerOfType(context, Entity.class);
          return Scopes.scopeFor(this.allAttributes(entity));
        }
      }
  ...
  public Iterable<? extends EObject> allAttributes(final Entity entity) {
    ArrayList<Attribute> _xblockexpression = null;
    {
      ...
      while ((e != null)) {
        {
          boolean _contains = alreadySeen.contains(e);
          if (_contains) {
