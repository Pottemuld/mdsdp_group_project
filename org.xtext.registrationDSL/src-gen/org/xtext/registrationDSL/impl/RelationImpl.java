...
public class RelationImpl extends FieldImpl implements Relation
{
    ...
    if (target != null && target.eIsProxy())
    {
      ...
      if (target != oldTarget)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, RegistrationDSLPackage.RELATION__TARGET, oldTarget, target));
      }
    }
    return target;
  }
  ...
  public void setTarget(Entity newTarget)
  {
    ...
    target = newTarget;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RegistrationDSLPackage.RELATION__TARGET, oldTarget, target));
  }
